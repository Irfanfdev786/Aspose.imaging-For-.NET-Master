...
namespace Aspose.Imaging.Live.Demos.UI.Models
{
	...
	public abstract class ModelBase : ApiController
	{
		...
		{
			string sourceFolder = Aspose.Imaging.Live.Demos.UI.Config.Configuration.WorkingDirectory + folderName;
	  ...
	  bool deleteSourceFolder = true, string zipFileName = null)
		{
			...
			string zipOutFolder = Aspose.Imaging.Live.Demos.UI.Config.Configuration.OutputDirectory + guid;
			string zipOutfileName, zipOutPath;
			if (string.IsNullOrEmpty(zipFileName))
			{
				zipOutfileName = guid + ".zip";
				zipOutPath = Aspose.Imaging.Live.Demos.UI.Config.Configuration.OutputDirectory + zipOutfileName;
			}
			else
			{
				...
				zipOutPath = Aspose.Imaging.Live.Demos.UI.Config.Configuration.OutputDirectory + guid2;
				if (createZip)
				{
			...
			{
				outFolder = guid;
				outPath = Aspose.Imaging.Live.Demos.UI.Config.Configuration.OutputDirectory + outFolder;
